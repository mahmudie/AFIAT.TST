...
using AFIAT.TST.MultiTenancy.HostDashboard;
...
namespace AFIAT.TST.Tests.HostDashboard
{
    ...
    public class HostDashboardAppService_Tests : AppTestBase
    {
        ...
        private void CreatePaidPayment(TSTDbContext context, SubscriptionPayment subscriptionPayment)
        {
