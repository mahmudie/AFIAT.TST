...
using AFIAT.TST.Web.Authentication.TwoFactor;
using AFIAT.TST.Web.Models.TokenAuth;
...
using AFIAT.TST.Web.Authentication.External;
...
namespace AFIAT.TST.Web.Controllers
{
    ...
    public class TokenAuthController : TSTControllerBase
    {
