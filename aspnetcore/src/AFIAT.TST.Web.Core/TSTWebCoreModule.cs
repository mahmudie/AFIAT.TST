...
using AFIAT.TST.Web.Configuration;
using AFIAT.TST.Web.DashboardCustomization;

namespace AFIAT.TST.Web
{
    [DependsOn(
        typeof(TSTApplicationModule),
        typeof(TSTEntityFrameworkCoreModule),
    ...
    public class TSTWebCoreModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TSTWebCoreModule(IWebHostEnvironment env)
        {
            _env = env;
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Modules.AbpAspNetCore()
                .CreateControllersForAppServices(
                    typeof(TSTApplicationModule).GetAssembly()
                );
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TSTWebCoreModule).GetAssembly());
        }
        ...
        public override void PostInitialize()
        {
            ...
            IocManager.Resolve<ApplicationPartManager>()
                .AddApplicationPartsIfNotAddedBefore(typeof(TSTWebCoreModule).Assembly);
        }
