...
using AFIAT.TST.Core.Base;
using AFIAT.TST.Core.Extensions;
using AFIAT.TST.Dto;
using AFIAT.TST.Types;

namespace AFIAT.TST.Queries
{
    public class OrganizationUnitQuery : TSTQueryBase<ListGraphType<OrganizationUnitType>, List<OrganizationUnitDto>>
    {
