...
{
    [DependsOn(
        typeof(TSTWebCoreModule)
    )]
    public class TSTWebFrontEndModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TSTWebFrontEndModule(IWebHostEnvironment env, TSTEntityFrameworkCoreModule abpZeroTemplateEntityFrameworkCoreModule)
        {
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TSTWebFrontEndModule).GetAssembly());
        }
    }
}
