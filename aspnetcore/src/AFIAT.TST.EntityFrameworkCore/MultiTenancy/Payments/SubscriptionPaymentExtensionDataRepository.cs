...
using AFIAT.TST.EntityFrameworkCore.Repositories;

namespace AFIAT.TST.MultiTenancy.Payments
{
    public class SubscriptionPaymentExtensionDataRepository : TSTRepositoryBase<SubscriptionPaymentExtensionData, long>,
        ISubscriptionPaymentExtensionDataRepository
    {
        public SubscriptionPaymentExtensionDataRepository(IDbContextProvider<TSTDbContext> dbContextProvider) : base(dbContextProvider)
        {
        }
