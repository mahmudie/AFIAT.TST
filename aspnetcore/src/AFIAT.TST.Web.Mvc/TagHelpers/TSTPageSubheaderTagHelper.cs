...
using AFIAT.TST.UiCustomization.Dto;

namespace AFIAT.TST.Web.TagHelpers
{
    ...
    public class TSTPageSubheaderTagHelper : TagHelper
    {
        ...
        public TSTPageSubheaderTagHelper(IUiThemeCustomizerFactory uiThemeCustomizerFactory)
        {
