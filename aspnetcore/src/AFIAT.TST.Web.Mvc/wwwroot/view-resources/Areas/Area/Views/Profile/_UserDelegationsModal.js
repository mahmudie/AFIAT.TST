(function ($) {
    app.modals.UserDelegationsModal = function () {
        ...
        var _createNewUserDelegationModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/CreateNewUserDelegationModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_CreateNewUserDelegationModal.js',
