(function () {
    ...
    app.modals.InactivityControllerNotifyModal.create = function () {
        var modal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Common/InactivityControllerNotifyModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Common/Modals/_InactivityControllerNotifyModal.js',
