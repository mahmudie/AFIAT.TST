(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Editions/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Editions/_CreateModal.js',
            modalClass: 'CreateEditionModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Editions/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Editions/_EditModal.js',
            modalClass: 'EditEditionModal'
        });

        var _moveTenantsToAnotherEditionModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Editions/MoveTenantsToAnotherEdition',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Editions/_MoveTenantsToAnotherEditionModal.js',
