(function () {
    $(function () {
        ...
        var _entityTypeFullName = 'AFIAT.TST.MultiTenancy.Tenant';
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + "Area/Tenants/CreateModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Area/Views/Tenants/_CreateModal.js",
            modalClass: "CreateTenantModal"
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + "Area/Tenants/EditModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Area/Views/Tenants/_EditModal.js",
            modalClass: "EditTenantModal"
        });

        var _featuresModal = new app.ModalManager({
            viewUrl: abp.appPath + "Area/Tenants/FeaturesModal",
            scriptUrl: abp.appPath + "view-resources/Areas/Area/Views/Tenants/_FeaturesModal.js",
