$(function () {
    ...
    var url = abp.appPath + 'Area/DemoUiComponents/UploadFile';
    $('#fileupload').fileupload({
        ...
        dropZone: $('#fileuploadForm'),
            ...
            if (jsonResult.success) {
                var fileUrl = abp.appPath + 'Area/DemoUiComponents/GetFile?id=' + jsonResult.result.id + '&contentType=' + jsonResult.result.contentType;
