(function ($) {
    $(function () {
        ...
        var mySettingsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/MySettingsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_MySettingsModal.js',
        ...
        var changePasswordModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/ChangePasswordModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_ChangePasswordModal.js',
        ...
        var changeProfilePictureModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/ChangePictureModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_ChangePictureModal.js',
        ...
        var userLoginAttemptsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Users/LoginAttemptsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Users/_LoginAttemptsModal.js',
        ...
        var manageLinkedAccountsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/LinkedAccountsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_LinkedAccountsModal.js',
        ...
        var userDelegationsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Profile/UserDelegationsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Profile/_UserDelegationsModal.js',
