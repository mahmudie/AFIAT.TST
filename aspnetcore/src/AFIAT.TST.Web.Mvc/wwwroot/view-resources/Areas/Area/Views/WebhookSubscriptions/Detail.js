(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/WebhookSubscription/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/WebhookSubscriptions/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        },
                        {
                            ...
                            action: function (data) {
                                window.location = "/Area/WebhookSubscription/WebhookEventDetail/" + data.record.webhookEventId;
                            }
                        }]
                    }
                },
