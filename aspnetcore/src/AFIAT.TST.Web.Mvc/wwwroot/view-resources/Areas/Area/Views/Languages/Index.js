(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Languages/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Languages/_CreateOrEditModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            action: function (data) {
                                document.location.href = abp.appPath + "Area/Languages/Texts?languageName=" + data.record.name;
                            }
                        }, {
