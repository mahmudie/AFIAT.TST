(function () {
    $(function () {
        ...
        var _createModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/OrganizationUnits/CreateModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/OrganizationUnits/_CreateModal.js',
            modalClass: 'CreateOrganizationUnitModal'
        });

        var _editModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/OrganizationUnits/EditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/OrganizationUnits/_EditModal.js',
            modalClass: 'EditOrganizationUnitModal'
        });

        var _addUserModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/OrganizationUnits/AddMemberModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/OrganizationUnits/_AddMemberModal.js',
        ...
        var _addRoleModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/OrganizationUnits/AddRoleModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/OrganizationUnits/_AddRoleModal.js',
