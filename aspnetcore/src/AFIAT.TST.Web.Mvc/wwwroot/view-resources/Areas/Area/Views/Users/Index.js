(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Users/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Users/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditUserModal'
        });

        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Users/_PermissionsModal.js',
                ...
                },
                {
                    ...
                    rowAction: {
                        ...
                        items: [{
                            ...
                            visible: function () {
                                return _dynamicEntityPropertyManager.canShow('AFIAT.TST.Authorization.Users.User');
                            },
                            action: function (data) {
                                _dynamicEntityPropertyManager.modal.open({
                                    entityFullName: 'AFIAT.TST.Authorization.Users.User',
