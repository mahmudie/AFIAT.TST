(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/DynamicProperty/CreateOrEditModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/DynamicProperties/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditDynamicPropertyModal',
            cssClass: 'scrollable-modal'
        });

        var _manageValuesModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/DynamicProperty/ManageValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/_Bundles/dynamic-properties-manage-values.min.js',
