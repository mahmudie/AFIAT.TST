(function () {
    app.modals.EntityTypeHistoryModal = function () {
        ...
        function showEntityChangeDetails(entityChange) {
            var entityChangeDetailModal = new app.ModalManager({
                viewUrl: abp.appPath + 'Area/AuditLogs/EntityChangeDetailModal',
    ...
    app.modals.EntityTypeHistoryModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Area/Common/EntityTypeHistoryModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Common/Modals/_EntityTypeHistoryModal.js',
