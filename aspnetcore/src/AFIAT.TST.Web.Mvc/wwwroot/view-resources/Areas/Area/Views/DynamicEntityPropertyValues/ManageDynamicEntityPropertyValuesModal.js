(function () {
    ...
    app.modals.ManageDynamicEntityPropertyValuesModal.create = function () {
        return new app.ModalManager({
            viewUrl: abp.appPath + 'Area/DynamicEntityPropertyValue/ManageDynamicEntityPropertyValuesModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/DynamicEntityPropertyValues/ManageDynamicEntityPropertyValuesModal.js',
