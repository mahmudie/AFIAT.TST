(function () {
    $(function () {
        ...
        var _selectAnEntity = new app.ModalManager({
            viewUrl: abp.appPath + 'Area/DynamicProperty/SelectAnEntityModal',
            scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/DynamicProperties/_SelectAnEntityModal.js',
                    ...
                    },
                    {
                        ...
                        rowAction: {
                            element: $("<button/>")
                                ...
                                .click(function () {
                                    window.location.href = "/Area/DynamicEntityProperty/" + $(this).data().entityFullName;
                                })
                        }
                    },
                    {
