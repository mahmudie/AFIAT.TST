    ...
    getFormattedMessages: function (messages) {
        $.each(messages, function (index, message) {
            ...
            if (message.message.startsWith('[image]')) {
                ...
                var imageUrl = abp.appPath + 'Area/Chat/GetImage?id=' + message.id + '&contentType=' + image.contentType;
                ...
                var fileUrl = abp.appPath + 'Area/Chat/GetFile?id=' + message.id + '&contentType=' + file.contentType;
...
(function ($) {
    $(function () {
        ...
        var url = abp.appPath + 'Area/Chat/UploadFile';
