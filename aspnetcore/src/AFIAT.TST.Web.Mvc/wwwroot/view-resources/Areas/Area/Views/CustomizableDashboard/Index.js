$(function () {
    ...
    var _addWidgetModal = new app.ModalManager({
        viewUrl: abp.appPath + 'Area/' + $('#DashboardName').val() + '/AddWidgetModal',
        scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/CustomizableDashboard/_AddWidgetModal.js',
