...
(function ($) {
    ...
    app.UserNotificationHelper = (function () {
        ...
        return function () {
            ...
            /* Example:
            abp.notifications.messageFormatters['AFIAT.TST.MyNotificationDataType'] = function(userNotification) {
            ...
            */
            ...
            function getUrl(userNotification) {
                switch (userNotification.notification.notificationName) {
                    case 'App.NewUserRegistered':
                        return '/Area/users?filterText=' + userNotification.notification.data.properties.emailAddress;
                    case 'App.NewTenantRegistered':
                        return '/Area/tenants?filterText=' + userNotification.notification.data.properties.tenancyName;
            ...
            var openSettingsModal = function () {
                new app.ModalManager({
                    viewUrl: abp.appPath + 'Area/Notifications/SettingsModal',
                    scriptUrl: abp.appPath + 'view-resources/Areas/Area/Views/Notifications/_SettingsModal.js',
