...
namespace AFIAT.TST.Web.Startup
{
    ...
    public class TSTWebMvcModule : AbpModule
    {
        private readonly IConfigurationRoot _appConfiguration;

        public TSTWebMvcModule(IWebHostEnvironment env)
        {
        ...
        public override void PreInitialize()
        {
            ...
            Configuration.Navigation.Providers.Add<AreaNavigationProvider>();
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TSTWebMvcModule).GetAssembly());
        }
