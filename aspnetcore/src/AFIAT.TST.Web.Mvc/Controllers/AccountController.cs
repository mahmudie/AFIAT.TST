...
using AFIAT.TST.Web.Models.Account;
...
using AFIAT.TST.Web.Security.Recaptcha;
using AFIAT.TST.Web.Session;
using AFIAT.TST.Web.Views.Shared.Components.TenantChange;
...
namespace AFIAT.TST.Web.Controllers
{
    public class AccountController : TSTControllerBase
    {
        ...
        {
            return Url.Action("Index", "Home", new { area = "Area" });
        }
