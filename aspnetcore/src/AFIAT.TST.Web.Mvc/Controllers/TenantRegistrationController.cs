...
using AFIAT.TST.Web.Models.TenantRegistration;

namespace AFIAT.TST.Web.Controllers
{
    public class TenantRegistrationController : TSTControllerBase
    {
            ...
            try
            {
                    ...
                    !_webUrlService.SupportsTenancyNameInUrl)
                {
                    ...
                    if (loginResult.Result == AbpLoginResultType.Success)
                    {
                        ...
                        return Redirect(Url.Action("Index", "Home", new { area = "Area" }));
                    }
