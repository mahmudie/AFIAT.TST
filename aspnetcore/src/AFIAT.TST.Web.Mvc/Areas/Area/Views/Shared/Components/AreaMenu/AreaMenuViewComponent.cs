...
{
    public class AreaMenuViewComponent : TSTViewComponent
    {
        private readonly IUserNavigationManager _userNavigationManager;
        private readonly IAbpSession _abpSession;
        private readonly TenantManager _tenantManager;

        public AreaMenuViewComponent(
        ...
        public async Task<IViewComponentResult> InvokeAsync(bool isLeftMenuUsed, string currentPageName = null)
        {
            ...
            {
                Menu = await _userNavigationManager.GetMenuAsync(AreaNavigationProvider.MenuName, _abpSession.ToUserIdentifier()),
            ...
            var subscriptionManagement = FindMenuItemOrNull(model.Menu.Items, AreaPageNames.Tenant.SubscriptionManagement);
