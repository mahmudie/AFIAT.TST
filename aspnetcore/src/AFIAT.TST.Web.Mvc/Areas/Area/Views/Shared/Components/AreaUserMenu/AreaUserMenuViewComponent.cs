...
namespace AFIAT.TST.Web.Areas.Area.Views.Shared.Components.AreaUserMenu
{
    public class AreaUserMenuViewComponent : TSTViewComponent
    {
        private readonly IMultiTenancyConfig _multiTenancyConfig;
        private readonly IAbpSession _abpSession;
        private readonly IPerRequestSessionCache _sessionCache;

        public AreaUserMenuViewComponent(
