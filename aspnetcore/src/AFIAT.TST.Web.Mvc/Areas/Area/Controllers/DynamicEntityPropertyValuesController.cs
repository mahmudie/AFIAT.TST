...
using AFIAT.TST.Web.Areas.Area.Models.DynamicEntityPropertyValues;
...
namespace AFIAT.TST.Web.Areas.Area.Controllers
{
    ...
    public class DynamicEntityPropertyValuesController : TSTControllerBase
    {
        ...
        [HttpGet("/Area/DynamicEntityPropertyValue/ManageAll/{entityFullName}/{entityId}")]
