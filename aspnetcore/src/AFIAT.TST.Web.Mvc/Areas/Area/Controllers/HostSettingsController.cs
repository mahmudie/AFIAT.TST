...
using AFIAT.TST.Configuration.Host;
using AFIAT.TST.Editions;
using AFIAT.TST.Timing;
using AFIAT.TST.Timing.Dto;
using AFIAT.TST.Web.Areas.Area.Models.HostSettings;
...
namespace AFIAT.TST.Web.Areas.Area.Controllers
{
    ...
    public class HostSettingsController : TSTControllerBase
    {
