...
using AFIAT.TST.Controls;
using AFIAT.TST.Dto;
using AFIAT.TST.Extensions;
using AFIAT.TST.Localization;
using AFIAT.TST.UI;
using AFIAT.TST.UI.Assets;
using AFIAT.TST.Views;
using DependencyResolver = AFIAT.TST.Core.Dependency.DependencyResolver;

namespace AFIAT.TST.ViewModels
{
    public class MainViewModel : XamarinViewModel
    {
        ...
        private const string ApplicationName = "TST";
