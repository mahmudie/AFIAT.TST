...
using AFIAT.TST.Web.Startup.ExternalLoginInfoProviders;
...
namespace AFIAT.TST.Web.Startup
{
    ...
    public class TSTWebHostModule : AbpModule
    {
        private readonly IWebHostEnvironment _env;
        private readonly IConfigurationRoot _appConfiguration;

        public TSTWebHostModule(
        ...
        {
            IocManager.RegisterAssemblyByConvention(typeof(TSTWebHostModule).GetAssembly());
        }
